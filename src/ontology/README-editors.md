These notes are for the EDITORS of hero
...
Make sure you have an ID range in the [idranges file](hero-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [hero-edit.owl](hero-edit.owl)

** DO NOT EDIT hero.obo OR hero.owl in the top level directory **

[../../hero.owl](../../hero.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/dillerm/HERO) for details.
 ...
 * [hero-idranges.owl](hero-idranges.owl)
...
This generates derived files such as hero.owl and hero.obo and places
 ...
 * https://github.com/dillerm/HERO/releases
 * https://github.com/dillerm/HERO/releases/new
...
what is in the `owl:versionIRI` of the derived hero.owl (`data-version` in
hero.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/hero.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/hero/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/dillerm/HERO.svg?branch=master)](https://travis-ci.org/dillerm/HERO)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/dillerm](https://travis-ci.org/profile/dillerm)
 2. click the "Sync account" button
 3. Click the tick symbol next to HERO
